...
from igneous import downsample, validate_by_template_matching
...
def test_image_validation():
    img = np.ones((200,200,100), dtype=np.bool)
    assert validate_by_template_matching(img) 
     
    img[50:160, 50:160, 20:70] = False 
    result = validate_by_template_matching(img) 
