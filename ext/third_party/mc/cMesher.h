...
class cMesher {
  private:
    zi::mesh::marching_cubes<IDType> mc;
  ...
  bool write_obj(const IDType id, const std::string &filename) {
    zi::mesh::int_mesh im;
